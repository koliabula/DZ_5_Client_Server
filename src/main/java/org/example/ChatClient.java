...
//        new Thread(serverListener).start();
        ...
        while (true) {
          ...
          System.out.println("4. Отключится от сервера");

          String type = console.nextLine();
          if (type.equals("1")) {
            // TODO: считываете с консоли логин, кому отправить

            org.example.SendMessageRequest request = new SendMessageRequest();
            ...
            org.example.BroadcastMessageRequest request = new BroadcastMessageRequest();
            request.setMessage(console.nextLine());
...
//            request.setRecipient(clientLogin);
//
//            String sendMsgRequest = objectMapper.writeValueAsString(request.getMessage());
            out.println(LIST_USERS + " " + clientLogin);
          }
...
//            });
            ...
            org.example.DisconnectRequest request = new DisconnectRequest();
            request.setMessage("Отключился от сервера");
            request.setRecipient(clientLogin);
